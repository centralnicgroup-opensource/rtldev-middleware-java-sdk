...
public class APIClient {
    ...
    public Response login() {
        ...
        cmd.put("persistent", "1");
        Response rr = this.request(cmd);
        return rr;
    }

    /**
     * Perform API login to start session-based communication. Use given specific
     * command
     * parameters.
     * 
    ...
    public Response request(Map<String, Object> cmd) {
        ...
        newcmd = this.autoIDNConvert(newcmd); // TODO: convert idns in cnr?
        ...
        if (this.debugMode) {
            ...
            System.err.println(cfg.get("CONNECTION_URL"));
    ...
    public APIClient useOTESystem() {
        ...
        this.socketConfig.setOpMode("OTE");
        return this;
    }
