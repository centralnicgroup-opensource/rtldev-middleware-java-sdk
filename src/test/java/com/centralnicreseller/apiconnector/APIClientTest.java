...
public class APIClientTest {
    ...
    public void setSession1() {
        ...
        String validate = "s_sessionid=12345678&s_command=COMMAND%3DStatusAccount";
    ...
    public void setSession2() {
        ...
        cmd.put("COMMAND", "StatusAccount");
        String tmp = cl.getPOSTData(cmd);
        String validate = "s_login=myaccountid%3Amyrole&s_sessionid=12345678&s_command=COMMAND%3DStatusAccount";
        assertEquals(validate, tmp);
    }
    ...
    public void setCredentials3() {
        APIClient cl = new APIClient();
        cl.setSession("1231231").setCredentials("myaccountid", "mypassword");
        Map<String, String> cmd = new HashMap<>();
        cmd.put("COMMAND", "StatusAccount");
        String tmp = cl.getPOSTData(cmd);
        String validate = "s_login=myaccountid&s_pw=mypassword&s_command=COMMAND%3DStatusAccount";
    ...
    public void logout2() {
        ...
        cl.useOTESystem()
                .setSession("212313")
                .setCredentials(System.getenv("CNR_TEST_USER"))
                .enableDebugMode();
